...
.dshpw-remote-lan,.dshpw-remote-public{display:grid;grid-template-columns:112px minmax(0,1fr);gap:24px;align-items:center;margin-top:11px}
.dshpw-remote-qr{width:112px;height:112px;padding:6px;border:1px solid var(--dsw-alias-border-l2);border-radius:11px;background:#fff}.dshpw-remote-qr-placeholder{width:112px;height:112px;display:grid;place-items:center;padding:8px;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);border-radius:11px;background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-tertiary);font-size:12px;text-align:center}.dshpw-remote-qr.small{width:112px;height:112px}
...
.dshpw-remote-switch{appearance:none;display:flex;align-items:center;justify-content:flex-start;flex:none;box-sizing:border-box;width:43px;height:25px;padding:3px;border:1px solid var(--dsw-alias-border-l2,#d1d5db);border-radius:999px;background:var(--dsw-alias-fill-tertiary,#d1d5db);cursor:pointer}.dshpw-remote-switch span{display:block;box-sizing:border-box;flex:none;width:19px;height:19px;border:1px solid var(--dsw-alias-border-l2,#d1d5db);border-radius:50%;background:var(--dsw-alias-bg-layer-1,#fff);box-shadow:0 1px 2px rgba(0,0,0,.12);transition:transform .18s}.dshpw-remote-switch.on{background:var(--dsw-alias-brand-primary,#4f6ef7)}.dshpw-remote-switch.on span{transform:translateX(16px)}.dshpw-remote-switch:disabled{opacity:.5;cursor:default}
