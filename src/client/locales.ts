...
export const zh = {
  ...
  remoteLanLoginHint: '扫码后先进入 Passwords 登录页，认证成功再打开 DSH。',
  remoteCopyAddress: '复制地址',
  remoteCopied: '地址已复制',
  remoteCopyFailed: '复制失败，请手动选择地址',
  remoteLanSecurityHint: '统一使用 Passwords 网关，不再额外暴露 3081 未鉴权入口。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  remoteLanLoginHint: 'Scan to open the Passwords sign-in page, then continue to DSH.',
  remoteCopyAddress: 'Copy address',
  remoteCopied: 'Address copied',
  remoteCopyFailed: 'Copy failed; select the address manually',
  remoteLanSecurityHint: 'Uses the Passwords gateway only; no extra unauthenticated port 3081 entry.',
