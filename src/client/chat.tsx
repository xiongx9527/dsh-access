...
@media (max-width: 640px){
  ...
  .dsh-access-chat-header{padding-top:max(10px,env(safe-area-inset-top));padding-right:max(12px,env(safe-area-inset-right));padding-left:max(12px,env(safe-area-inset-left))}
  .dsh-access-chat-close{width:44px;height:44px}
  .dsh-access-chat-composer{padding-bottom:max(10px,env(safe-area-inset-bottom));padding-right:max(12px,env(safe-area-inset-right));padding-left:max(12px,env(safe-area-inset-left))}
  .dsh-access-chat-tagbtn,.dsh-access-chat-send{min-height:44px}
}
`;
